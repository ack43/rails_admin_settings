# $(document).on "click", "#edit_rails_admin_settings_setting .raw_hash_field .rails_admin_settings_hash_element_renamer_link", (ev)->
#   ev.preventDefault()
#   renamer_link = $(ev.currentTarget)
#   label = renamer_link.closest('.rails_admin_settings_hash_element_block').find('label')
#   input = renamer_link.closest('.rails_admin_settings_hash_element_block').find('input')
...
$(document).on 'blur', '#edit_rails_admin_settings_setting .raw_hash_field .rails_admin_settings_hash_element_block input', (e)->
  ...
  # $(document).on 'click', '.rails_admin_settings_hash_element_duplicate_trigger', (e)->
  #   e.preventDefault()
  #   link = $(e.currentTarget)
